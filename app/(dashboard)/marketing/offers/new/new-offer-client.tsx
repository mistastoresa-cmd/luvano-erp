...
export function NewOfferClient({
  ...
  const [targetScope, setTargetScope] = useState<'all' | 'product' | 'category'>('all')
      ...
      {active && (
        ...
        >
          ...
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
            ...
            <div className="sm:col-span-2">
              <Label htmlFor="targetScope">نطاق التطبيق</Label>
              <select
                id="targetScope"
                name="targetScope"
                value={targetScope}
            ...
            {targetScope === 'product' && (
              <div className="sm:col-span-2">
                <Label htmlFor="targetProductId">المنتج المستهدف *</Label>
                <select
                  id="targetProductId"
            ...
            {targetScope === 'category' && (
              <div className="sm:col-span-2">
                <Label htmlFor="targetCategory">التصنيف المستهدف *</Label>
                {categories.length > 0 ? (
                  <select
                    id="targetCategory"
                    name="targetCategory"
                  ...
                  <Input id="targetCategory" name="targetCategory" required placeholder="عطور رجالية" />
                )}
              </div>
            )}
